...
{ id: "watermelon", icon: "🍉",  readings: ["すいか", "くだもの", "すいかわり","フルーツ","たね", "ウォーターメロン"], visualDescription: "スイカの絵文字"},
...
{ id: "deer", icon: "🦌", name: "しか", category: "どうぶつ", readings: ["しか", "シカ", "どうぶつ", "つの", "のはら"], visualDescription: "角のある鹿として描かれた動物の絵文字" }, 
